...
export function ExpandableCardDemo() {
    ...
    return (
        <div className="bg-black" style={styles.footer}>
            <AnimatePresence>
                ...
                {active && typeof active === "object" ? (
                    <div className="fixed inset-0  grid place-items-center z-[100]">
                        ...
                        <motion.div
                            ...
                            ref={ref}
                            className="w-full max-w-[500px] h-fit md:h-fit md:max-h-[72%]  flex flex-col bg-black dark:bg-neutral-900 sm:rounded-3xl overflow-auto">
                            {/* bg-white -> bg-black  in upper css */}
